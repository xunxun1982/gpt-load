...
type GroupConfig struct {
	...
	// stream_first_byte_timeout independently guards the wait for the first stream byte.
...
type RequestLog struct {
	...
	SimulatedClientEnabled bool   `gorm:"not null;default:false" json:"simulated_client_enabled"`
