...
type SystemSettings struct {
	...
	NonStreamRequestTimeout int    `json:"non_stream_request_timeout" default:"600" name:"config.non_stream_request_timeout" category:"config.category.request" desc:"config.non_stream_request_timeout_desc" validate:"required,min=1"`
