...
var MessagesJaJP = map[string]string{
	...
	"group.duplicate_name":       "グループ名 {{.name}} は既に存在します",
	...
	"config.stream_request_timeout":                        "ストリームリクエストタイムアウト（秒）",
	"config.stream_request_timeout_desc":                   "ストリーム転送リクエストの完全なライフサイクルタイムアウト（秒）。0で全体タイムアウトを無効化します。",
	...
	"config.proxy_pool_test_timeout_seconds_desc":          "単一のプロキシプール接続検査の最大待機時間（秒）。",
	"config.proxy_pool_auto_test_interval_minutes":         "プロキシプール定期検査間隔（分）",
	"config.proxy_pool_auto_test_interval_minutes_desc":    "プロキシプール画面で定期検査を有効にした場合の自動検査間隔（分）。",
	"config.gateway_proxy_test_timeout_seconds":            "ゲートウェイプロキシ検査タイムアウト（秒）",
	"config.gateway_proxy_test_timeout_seconds_desc":       "単一のゲートウェイプロキシ TCP 接続検査の最大待機時間（秒）。",
	"config.gateway_proxy_auto_test_interval_minutes":      "ゲートウェイプロキシ自動検査間隔（分）",
	"config.gateway_proxy_auto_test_interval_minutes_desc": "ゲートウェイノードの自動検査と選択の間隔（分）。",
	...
	"config.category.proxy_pool": "プロキシプール",
	...
	"success.health_reset":             "ヘルスメトリクスが正常にリセットされました",
	...
	"error.child_group_sync_failed":                     "親グループの変更と子グループの同期に失敗しました",
