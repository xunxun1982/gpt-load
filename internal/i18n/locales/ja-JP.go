...
var MessagesJaJP = map[string]string{
	...
	"validation.sub_group_weight_max_exceeded":                 "サブグループの重みは5000を超えることはできません",
	"validation.sub_group_min_effective_weight_negative":       "最低有効重みは負の値にできません",
	"validation.sub_group_min_effective_weight_max_exceeded":   "最低有効重みは5000を超えることはできません",
	"validation.sub_group_min_effective_weight_exceeds_weight": "最低有効重みは基本重みを超えることはできません",
	...
	"validation.codex_support_cannot_disable_used_by_codex":    "Codexサポートを無効化できません。このグループは現在次のOpenAI Responses集約グループで使用されています：{{.groups}}。まずこれらの集約グループからこのグループを削除してから、Codexサポートを無効化してください",
	"validation.force_cc_codex_mutually_exclusive":             "同じグループで強制CCと強制Codexを同時に有効化することはできません",
	...
	"dashboard.cacheTokens":                                      "キャッシュトークン",
	"dashboard.thinkingTokens":                                   "思考トークン",
	"dashboard.estimatedTokens":                                  "推定トークン",
