...
var MessagesEnUS = map[string]string{
	...
	"group.duplicate_name":       "Group name {{.name}} already exists",
	...
	"config.proxy_pool_test_timeout_seconds_desc":          "Maximum wait time in seconds for a single proxy pool connectivity check.",
	"config.proxy_pool_auto_test_interval_minutes":         "Proxy Pool Auto-Test Interval (minutes)",
	"config.proxy_pool_auto_test_interval_minutes_desc":    "Automatic check interval in minutes when periodic proxy pool checks are enabled on the proxy pool page.",
	"config.gateway_proxy_test_timeout_seconds":            "Gateway Proxy Test Timeout (seconds)",
	"config.gateway_proxy_test_timeout_seconds_desc":       "Maximum wait time in seconds for a single gateway proxy TCP connectivity check.",
	"config.gateway_proxy_auto_test_interval_minutes":      "Gateway Proxy Auto-Test Interval (minutes)",
	"config.gateway_proxy_auto_test_interval_minutes_desc": "Automatic gateway node check interval in minutes.",
	...
	"config.category.proxy_pool": "Proxy Pool",
	...
	"validation.child_group_cannot_modify_upstream":     "Child groups cannot modify upstream URLs. Upstream is auto-managed and always points to parent group's proxy endpoint",
	"validation.child_group_cannot_export_individually": "Child groups cannot be exported individually, please export the parent group",
	"validation.child_group_cannot_import_individually": "Child groups cannot be imported individually, they are imported with their parent group",
	...
	"error.child_group_sync_failed":                     "Failed to synchronize child groups with parent group changes",
