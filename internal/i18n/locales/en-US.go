...
var MessagesEnUS = map[string]string{
	...
	"validation.sub_group_weight_max_exceeded":                 "Sub-group weight cannot exceed 5000",
	"validation.sub_group_min_effective_weight_negative":       "Minimum effective weight cannot be negative",
	"validation.sub_group_min_effective_weight_max_exceeded":   "Minimum effective weight cannot exceed 5000",
	"validation.sub_group_min_effective_weight_exceeds_weight": "Minimum effective weight cannot exceed base weight",
	...
	"validation.codex_support_cannot_disable_used_by_codex":    "Cannot disable Codex support. This group is currently used by the following OpenAI Responses aggregate group(s): {{.groups}}. Please remove this group from these aggregate groups first, then disable Codex support",
	"validation.force_cc_codex_mutually_exclusive":             "Force CC and Force Codex cannot both be enabled on the same group",
	...
	"dashboard.cacheTokens":                "Cache Tokens",
	"dashboard.thinkingTokens":             "Thinking Tokens",
	"dashboard.estimatedTokens":            "Estimated Tokens",
