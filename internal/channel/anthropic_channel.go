...
// NOTE: Version 2.1.0 is the latest stable release.
// This version matches the official Claude Code 2.1.0 release.
// Check: https://docs.anthropic.com/en/docs/claude-code/cli-reference
