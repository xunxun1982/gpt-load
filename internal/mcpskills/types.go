...
var APIBridgeTemplates = []APIBridgeTemplate{
	...
	},
	{
		...
		Description: "Tavily AI search API - optimized for AI agents and RAG applications",
		Category:    string(CategorySearch),
		Icon:        "🔎",
	...
	},
	{
		...
		Description: "Serper Google Search API - fast and reliable Google search results",
		Category:    string(CategorySearch),
		Icon:        "🌐",
		APIEndpoint: "https://google.serper.dev",
		...
		Tools: []ToolDefinition{
			{
				Name:        "search",
				Description: "Search Google using Serper API for web results",
				InputSchema: map[string]interface{}{
					"type": "object",
					"properties": map[string]interface{}{
