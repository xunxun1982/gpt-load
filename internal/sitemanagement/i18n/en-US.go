...
var MessagesEnUS = map[string]string{
	...
	"site_management.validation.invalid_bypass_method":           "Invalid bypass method",
	...
	"site_management.validation.auth_changed_retry":              "Site credentials changed; refresh and try again",
	"site_management.validation.configuration_changed_retry":     "Site configuration changed; refresh and try again",
	"site_management.validation.anyrouter_requires_cookie":       "AnyRouter supports cookie authentication only",
	"site_management.validation.anyrouter_user_id_required":      "User ID is required for enabled AnyRouter automation",
	"site_management.validation.anyrouter_cookie_required":       "Cookie is required for enabled AnyRouter automation",
	"site_management.validation.stealth_requires_cookie":         "Stealth bypass requires cookie authentication",
	"site_management.validation.stealth_cookie_required":         "Stealth bypass requires a cookie value",
	"site_management.validation.stealth_waf_cookie_required":     "Stealth bypass requires at least one browser protection cookie: {{.cookies}}",
	"site_management.validation.sub2api_requires_access_token":   "Enabled Sub2API automation requires Access Token authentication",
	"site_management.validation.sub2api_credential_required":     "Enabled Sub2API automation requires an Access Token or Refresh Token",
	"site_management.validation.sub2api_custom_checkin_required": "Sub2API has no built-in check-in; configure a custom check-in URL before enabling automatic check-in",
