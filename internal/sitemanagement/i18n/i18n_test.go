...
func TestValidationMessageKeys(t *testing.T) {
	validationKeys := []string{
		...
		"site_management.validation.invalid_bypass_method",
		"site_management.validation.balance_multiplier_min",
		"site_management.validation.auth_value_requires_auth_type",
		"site_management.validation.auth_changed_retry",
		"site_management.validation.configuration_changed_retry",
		"site_management.validation.anyrouter_requires_cookie",
		"site_management.validation.anyrouter_user_id_required",
		"site_management.validation.anyrouter_cookie_required",
		"site_management.validation.stealth_requires_cookie",
		"site_management.validation.stealth_cookie_required",
		"site_management.validation.stealth_waf_cookie_required",
		"site_management.validation.sub2api_requires_access_token",
		"site_management.validation.sub2api_credential_required",
		"site_management.validation.sub2api_custom_checkin_required",
