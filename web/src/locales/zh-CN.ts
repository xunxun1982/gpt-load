...
export default {
  ...
  common: {
    ...
    databaseBusy: "数据库繁忙，正在处理大量数据，请稍后重试",
    databaseBusyRetry: "数据库繁忙，{seconds}秒后自动重试...",
    info: "信息",
    yes: "是",
    no: "否",
    ok: "确定",
  ...
  dashboard: {
    ...
    rpm10Min: "10分钟RPM",
    requests24h: "24小时请求",
    tokens24h: "24小时 Tokens",
    modelTokenUsage: "模型 Tokens 使用",
    inputTokens: "输入 Tokens",
    outputTokens: "输出 Tokens",
    cacheTokens: "缓存 Tokens",
    thinkingTokens: "思考 Tokens",
    estimatedTokens: "估算 Tokens",
    includesEstimated: "其中估算",
    modelFilter: "模型筛选",
    allModels: "全部模型",
    model: "模型",
    totalTokens: "总 Tokens",
    noTokenUsage: "暂无 Tokens 使用数据",
  ...
  keys: {
    ...
    clearSuccess: "清除成功",
    clearingInBackground: "正在后台清除密钥，请查看进度条",
    restoringInBackground: "正在后台恢复密钥，请查看进度条",
    selectGroup: "请选择分组",
    clickToCopy: "点击复制",
    urlCopied: "地址已复制到剪贴板",
    keyCount: "密钥数量",
    ...
    weightMaxExceeded: "权重不能超过5000",
    weightRangeHint: "范围 0-5000（0=禁用）",
    newWeight: "新权重",
    currentWeight: "当前权重",
    minEffectiveWeight: "最低有效权重",
    ...
    healthResetEveryHours: "每 {count} 小时",
    healthResetEveryDays: "每 {count} 天",
    ...
    maxRequestSizeHint: "设置聚合分组的请求大小限制，超过此大小的请求将被拒绝（0 表示不限制）",
    preconditionNotMet: "请求不符合聚合分组的前置条件",
    addPrecondition: "添加前置条件",
    selectPrecondition: "选择前置条件类型",
    preconditionValue: "输入值",
    optional: "可选",
    testModelTooltip:
    ...
    upstreamProxyUrlTooltip:
      "此上游专用的代理服务器地址（支持 http/https/socks5）。如果配置，将优先使用此代理；如果为空，则使用分组或全局代理配置",
    upstreamProxyUrlPlaceholder: "直连上游",
    gatewayProxy: "网关代理",
    ...
    modelRedirectSimpleModeDesc: "一对一映射，每个源模型对应一个目标模型",
    modelRedirectAdvancedModeDesc: "一对多映射，支持权重分配和负载均衡",
    ...
    validationStream: "测试流式",
    validationStreamTip: "仅影响密钥测试请求；默认关闭，保持非流式测试。",
    validationPromptMode: "测试提示词",
    validationPromptModeDefault: "默认 hi",
    validationPromptModeRandomQueue: "短问题队列",
    validationPromptModeTip: "默认发送 hi；队列模式会从 100 条短问题中轮换，减少固定测试内容。",
    requestBehavior: "请求行为",
    requestBehaviorTooltip: "控制代理转发时对请求体参数的轻量改写。",
    requestStreamMode: "请求流式",
    requestStreamModeDefault: "默认（跟随客户端）",
    requestStreamModeForceStream: "强制流式",
    ...
    codexSupport: "强制 Codex 支持",
    codexSupportTooltip1: "启用 /codex 端点，兼容使用 OpenAI Responses 协议的 Codex 客户端。",
    codexSupportTooltip2: "请求会从 OpenAI Responses 格式转换为当前分组的上游协议。",
    codexSupportTooltip3: "同一个标准分组不能同时开启强制 CC 和强制 Codex。",
    codexSupportTip:
      "开启后，客户端可使用 /proxy/分组名/codex/v1/responses。OpenAI Responses 聚合分组只有命中强制 Codex 子组时才会转入该强制端点。",
    forceCCCodexMutuallyExclusive: "同一个标准分组不能同时开启强制 CC 和强制 Codex。",
    thinkingModel: "思考模型",
    ...
    importingPleaseWait: "正在导入分组，请稍候。您可以继续使用其他功能。",
    importTimeoutHint:
      "导入请求超时，但数据可能已成功导入。请刷新页面查看结果。如果导入失败，请稍后重试。",
    fetchModels: "获取模型",
  ...
  subGroups: {
    ...
    effectiveWeight: "有效权重",
    minEffectiveWeight: "最低有效权重",
    enterMinEffectiveWeight: "请输入最低有效权重",
    minEffectiveWeightCannotBeLessThanOne: "最低有效权重不能小于 1",
    minEffectiveWeightCannotExceedWeight: "最低有效权重不能超过基础权重",
    healthScore: "健康度",
    successRate: "成功率",
    requestCount: "请求数",
    lastFailure: "最后失败",
    lastSuccess: "最后成功",
    resetHealth: "重置健康度",
    resetAllHealth: "重置全部健康度",
    autoArrangeWeight: "自动分配权重",
    autoArrangeWeightTip: "根据缓存余额自动计算并分配子分组初始权重",
    autoWeightTitle: "自动分配初始权重",
    autoWeightStrategy: "分配策略",
    autoWeightStrategyBalance: "按余额自动分配",
    autoWeightStrategyUniform: "全部设为相同权重",
    autoWeightMin: "最低权重",
    autoWeightMax: "最高权重",
    autoWeightUniform: "统一权重",
    autoWeightHint:
      "余额为 - 的不修改；余额为 0 或计算结果低于最低权重的，设为最低权重；最近签到失败或从未签到的计算结果乘以 0.7。",
    autoWeightUniformHint: "将当前聚合分组下所有子分组的初始权重设置为指定值。",
    autoWeightNoEligible: "没有可用于计算权重的缓存余额",
    autoWeightNoSubGroups: "没有可更新的子分组",
    ...
    confirmResetAllHealth: "确定要重置当前聚合分组下所有子分组的健康度指标吗？",
    resetAllHealthTip: "重置当前聚合分组所有子分组的动态健康度指标",
    resetHealthSuccess: "健康度指标已重置",
    healthResetInterval: "健康度重置周期",
    healthResetFollowAggregate: "跟随聚合分组",
    healthResetOverrideHint: "设置后仅重置该子分组健康度；选择跟随则使用聚合分组默认周期",
  },
  logs: {
    title: "日志",
    requestLogs: "请求日志",
    ...
    exportLogs: "导出密钥",
    totalRecords: "共 {total} 条记录",
    currentPageRange: "显示第 {start}-{end} 条",
    currentPageNoRecords: "当前页暂无记录",
    recordsPerPage: "{count}条/页",
    previousPage: "上一页",
    nextPage: "下一页",
    pageInfo: "第 {current} 页，共 {total} 页",
    ...
    thinkingTokens: "思考 Tokens",
    tokenUsageSource: "统计来源",
    tokenSourceUpstream: "上游返回",
  ...
  charts: {
    ...
    timeRange: "时间范围",
    rangeLast24Hours: "最近24小时",
    rangeLast7Days: "最近1周",
    rangeLast1Month: "最近1个月",
    rangeToday: "本日",
    rangeYesterday: "昨日",
    rangeThisWeek: "本周",
    rangeLastWeek: "上周",
  ...
  proxyPool: {
    ...
    edit: "编辑代理",
    gatewayProxies: "网关代理",
    gatewaySectionHint: "内置 BetterClaude 节点，用于将上游 API 路由到网关前缀；和手动代理互斥",
    activeGateway: "当前使用",
    activeGatewayValue: "当前使用：{label}（{url}）",
    noGatewayAvailable: "当前没有可用网关节点",
    manualProxies: "手动代理",
    manualSectionHint: "单独添加的代理保留原有检测和选择方式",
    name: "名称",
    ...
    urlRequired: "请输入代理地址",
    invalidUrl: "仅支持 http、https、socks5 代理地址",
    protocol: "协议",
    available: "可用",
    bestProxy: "最快代理",
    noAvailableProxy: "暂无可用测速",
    details: "明细",
    country: "国家",
    autoUpdate: "自动更新",
    minutes: "分钟",
    ...
    test: "测试代理",
    testAll: "检测全部",
    testCurrentPage: "检测当前页",
    testSettings: "检测设置",
    proxyTestSettings: "代理检测",
    gatewayTestSettings: "网关检测",
    testTarget: "检测目标",
    invalidTestTarget: "请输入有效的 HTTP/HTTPS 检测目标",
    autoTest: "定期检测",
    autoTestInterval: "检测间隔（分钟）",
    autoTestIntervalHours: "{hours} 小时",
    autoTestIntervalMinutes: "{minutes} 分钟",
    testTimeout: "测试超时（秒）",
    testTimeoutValue: "{seconds} 秒",
    testTimeoutInline: "超时 {timeout}",
    testStatus: "检测状态",
    notTested: "未检测",
    testing: "检测中",
    testPassedShort: "正常 · {duration}ms",
    testFailedShort: "失败",
    testSuccess: "代理连通，耗时 {duration}ms",
    testFailed: "代理不可用：{error}",
    testRequestFailed: "代理检测请求失败",
    testGateway: "测试网关",
    gatewayTestSuccess: "网关可用，耗时 {duration}ms",
    gatewayTestFailed: "网关不可用：{error}",
    testAllFinished: "代理检测完成",
    settingsSaved: "代理池检测配置已保存",
    settingsLoadFailed: "获取代理池检测配置失败",
    settingsSaveFailed: "保存代理池检测配置失败",
    totalRecords: "共 {total} 个代理",
    calculatingTotal: "总数计算中",
  ...
  siteManagement: {
    ...
    balanceMultiplierPlaceholder: "留空时按 1",
    balanceMultiplierHint: "站点余额按获取余额除以倍率计算；留空按 1。",
    balanceMultiplierInvalid: "倍率必须为不小于 1 且可精确保存的整数",
    baseUrl: "站点链接",
    siteType: "站点类型",
    enabled: "启用",
    userId: "用户ID",
    ...
    autoBalance: "自动余额",
    autoBalanceConfig: "自动余额配置",
    autoBalanceConfigTooltip: "按站点管理时区从 00:00 起，每隔指定小时自动刷新余额",
    authType: "认证方式",
    authValue: "认证信息",
  ...
  database: {
    ...
    cannot_get_group: "无法获取分组信息",
    cannot_get_groups: "无法获取分组列表",
    group_stats_failed: "获取分组统计信息失败",
    import_failed: "导入失败",
    export_failed: "导出失败",
    rpm_stats_failed: "获取RPM统计信息失败",
    current_stats_failed: "获取当前统计信息失败",
    previous_stats_failed: "获取历史统计信息失败",
    chart_data_failed: "获取图表数据失败",
  },
  validation: {
    invalid_group_id: "无效的分组ID",
    invalid_group_name: "分组名称无效",
    invalid_channel_type: "不支持的渠道类型: {types}",
    invalid_group_type: "分组类型无效",
    test_model_required: "测试模型不能为空",
    test_model_empty: "测试模型不能为空",
    invalid_test_path: "验证端点路径无效",
    invalid_model_mapping: "模型映射格式无效: {error}",
    invalid_model_redirect: "模型重定向规则无效: {error}",
    aggregate_no_model_redirect: "聚合分组不支持模型重定向",
    sub_group_referenced_cannot_modify:
      "此分组被 {count} 个聚合分组引用，无法修改渠道类型或验证端点",
    cc_support_cannot_disable_used_by_anthropic:
      "此分组被以下Anthropic聚合分组使用，无法禁用CC支持: {groups}",
    codex_support_cannot_disable_used_by_codex:
      "此分组被以下 OpenAI Responses 聚合分组使用，无法禁用 Codex 支持: {groups}",
    force_cc_codex_mutually_exclusive: "同一个分组不能同时开启强制 CC 和强制 Codex",
    invalid_copy_keys_value: "复制密钥选项无效",
    child_group_cannot_export_individually: "子分组不能单独导出，请导出父分组",
  },
};
