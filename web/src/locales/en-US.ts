export default {
  ...
  settings: {
    ...
    exportSystemConfirm: "Are you sure you want to export the full system configuration (including system settings and all groups)?",
    importSystemConfirm: "Are you sure you want to import the full system configuration? This will overwrite existing system settings and all group configurations.",
    exportSuccess: "Export successful",
    importSuccess: "Import successful",
    exportFailed: "Export failed",
    importFailed: "Import failed",
