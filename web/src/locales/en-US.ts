export default {
  ...
  keys: {
    ...
    pathRedirectsTooltip1: "Rewrite client request paths to the paths required by the upstream (OpenAI channel only). Examples:",
    pathRedirectsTooltip2: "You can enter full URLs or relative paths starting with /v1; for aggregate groups, the selected sub-group rules will be applied automatically",
