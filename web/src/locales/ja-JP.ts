export default {
  ...
  keys: {
    ...
    pathRedirectsTooltip1: "クライアントのリクエストパスを上流サービスの要求するパスに書き換えます（OpenAI チャンネルのみ）。例：",
    pathRedirectsTooltip2: "フルURLまたは /v1 から始まる相対パスを指定できます。集約グループの場合は選択されたサブグループのルールが自動適用されます",
    pathRedirect: "パスルール",
